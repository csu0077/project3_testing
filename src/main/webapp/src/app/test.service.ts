...
export class TestService {
  ...
  runGroup(groupName: string): Observable<any> {
    /*const url : string = "http://ec2-52-15-86-178.us-east-2.compute.amazonaws.com:8080/AssignForce/tests/test?group=";*/
  ...
  runAllTests(): Observable<any> {
    /*const url : string = "http://ec2-52-15-86-178.us-east-2.compute.amazonaws.com:8080/AssignForce/tests/test?group=all";*/
